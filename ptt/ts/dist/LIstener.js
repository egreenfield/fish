    ...
    Listener.prototype.listenOnce = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.queuePromise) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.queuePromise];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.sqs.deleteMessageBatch({
                                QueueUrl: this.queueUrl,
                                Entries: messages.map(function (m, i) { return { Id: "" + i, ReceiptHandle: m.ReceiptHandle }; })
                            }).promise()];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [2 /*return*/, messages.map(function (v) { return v.Body; })];
                }
            });
        });
    };
